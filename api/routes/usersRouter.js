...
router.post('/register', requireBody(['username','password']), async (req, res, next) => {
  try {
    ...
    const user = await createUser(username, password, profile_image_url, location);
